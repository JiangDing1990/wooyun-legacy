...
> **注意：** 本 Skill 的知识蒸馏自 WooYun 公开漏洞数据（2010-2016）。由于数据年代较早，在涉及现代技术栈（如云原生、微服务、OAuth 2.0/OIDC、GraphQL、Serverless 等）的场景下效果可能有限。其核心价值在于**业务逻辑漏洞的思维模式和攻击模式分类**——这些在技术迭代中保持高度稳定。
